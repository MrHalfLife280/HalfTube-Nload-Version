...
<img src="assets/logo.png" width="120" height="48" alt="HalfTube" border="0" hspace="5" vspace="8">
...
<table width="80%" align="center" cellpadding="5" cellspacing="0" border="0">
    <tr valign="top">
        <td>
            <span class="highlight">What is HalfTube?</span>
            <br><br>
            HalfTube is a way to get your videos to the people who matter to you. With HalfTube you can:
            <ul>
                    ...
                    <form method="post" action="login.php">
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                <div style="font-size: 14px; font-weight: bold; color:#003366; margin-bottom: 5px;">HalfTube Log In</div>
                            </td>
                        </tr>
